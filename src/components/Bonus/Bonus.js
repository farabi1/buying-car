    ...
    return (
        <div className='bonus-container'>
            ...
            <div className="answer">
                ...
                <h3>Answer: "Props" are passed from one component to another.It can be used with state and functional components.Props are read-only.It is Immutable <br></br>
                    In "State" data is passed within the component only.It is Mutable.State is both read and write.</h3>
